...
<head>
    ...
    <title>Customer Details - Dream Bank</title>
...
<body style="background-color:white;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed fixed-top" style="font-family:candara;background-color:#861f41; color:white ;font-family:'Inter', sans-serif; font-size:18px; box-shadow: 0px 0px 10px 0px black;">
    ...
    <center>
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div style="width:80%; background-color:#861f41; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white; font-family:'Inter', sans-serif;">Customers Details</h1>
            </div>
