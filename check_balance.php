...
<head>
    ...
    <title>Balance Enquiry - Dream Bank</title>
    ...
    <center>
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            <div style="width:80%; background-color:#861f41; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;">Balance Enquiry</h1>
            </div>
            ...
            <div class="container" style=" backdrop-filter: blur(5px);  border-radius:5px; padding: 20px 20px 20px 20px; margin-top:50px; width:60%;">
                <form action="check_balance.php" method="post">
                    <input type="number" class="formin form-control" name="accno" id="" placeholder="Enter Your Account Number"><br>
                    <br><input class="btn mybtn btn-outline-light" type="submit" value="Submit"><br><br>
                    <p style="color:black;">If you Forget your Account Number? Check <a href="customer_details.php">Here</a>
                    </p>
                </form>
            </div>
        </div>
